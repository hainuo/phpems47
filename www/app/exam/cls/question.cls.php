...
class question_exam
{
	...
	{
		$data = ['DISTINCT questions.questionid', ['questions', 'quest2knows'], [["AND", "find_in_set(quest2knows.qkknowsid,:knowid)", 'knowid', $knowid], ["AND", "quest2knows.qktype = 0"], ["AND", "quest2knows.qkquestionid = questions.questionid"], ["AND", "questions.questiontype = :typeid", 'typeid', $typeid], ["AND", "questions.questionstatus = 1"]], false, false, false];
