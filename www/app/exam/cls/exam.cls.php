...
class exam_exam
{
    ...
    public function getExamSessionByUserid($userid, $basicid, $sessionid = 0, $usesession = 0)
    {
        ...
        if ($usesession) $args[] = ["AND", "examsessionid = :examsessionid", 'examsessionid', $sessionid];
    ...
    {
        $data = ['questions', ['questionstatus' => '0'], [["AND", "questionid = :questionid", 'questionid', $id]]];
        $sql = $this->pdosql->makeUpdate($data);
        return $this->db->exec($sql);
        //$this->db->affectedRows();
    }
    ...
    {
        $data = ['questions', ['questionstatus' => '0'], $args];
        $sql = $this->pdosql->makeUpdate($data);
        return $this->db->exec($sql);
        //$this->db->affectedRows();
    }
    ...
    {
        $data = ['questionrows', ['qrstatus' => '0'], [["AND", "qrid = :qrid", 'qrid', $id]]];
        $sql = $this->pdosql->makeUpdate($data);
        return $this->db->exec($sql);
        //$this->db->affectedRows();
    }
