        ...
        <div class="exambox" id="datacontent">
            <form class="examform form-horizontal" id="form1" name="form1" action="index.php?exam-app-exam-score"
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="index.php?exam-app-basics">{x2;$data['currentbasic']['basic']}</a> <span
                                class="divider">/</span>
                    </li>
                    <li>
                ...
                {x2;endif}
                {x2;eval: v:oid++}
                <div id="panel-type{x2;v:quest}"
                     class="tab-pane{x2;if:(!$ctype && v:qid == 1) || ($ctype == v:quest)} active{x2;endif}">
                    <ul class="breadcrumb">
                        <li>
                            <h5>{x2;v:oid}
                        ...
                        <div class="media well">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="btn-group pull-right">
                                    <button class="btn" type="button"
                                            onclick="javascript:signQuestion('{x2;v:question['questionid']}',this);"><em
                                                class="{x2;if:$sessionvars['examsessionsign'][v:question['questionid']]}icon-star{x2;else}icon-star-empty{x2;endif}"
                                                title="标注"></em></button>
                                </li>
                            </ul>
                            ...
                            <div class="media-body well">
                                ...
                                <label class="radio inline"><input type="radio"
                                                                   ...
                                                                   rel="{x2;v:question['questionid']}" value="{x2;v:so}"
                                ...
                                <input type="text" class="input-xlarge" name="question[{x2;v:question['questionid']}]"
                            ...
                            <div class="media-body well">
                                ...
                                <textarea class="jckeditor" etype="simple" id="editor{x2;$dataid}"
                                          name="question[{x2;$dataid}]"
                                          rel="{x2;v:question['questionid']}">{x2;realhtml:$sessionvars['examsessionuseranswer'][$dataid]}</textarea>
                            </div>
                            {x2;endif}
                        </div>
                    </div>
                        ...
                        <div class="media well">
                            ...
                            <div class="paperexamcontent">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="btn-group pull-right">
                                        <button class="btn" type="button"
                                                onclick="javascript:signQuestion('{x2;v:data['questionid']}',this);"><em
                                                    class="{x2;if:$sessionvars['examsessionsign'][v:data['questionid']]}icon-star{x2;else}icon-star-empty{x2;endif}"
                                                    title="标注"></em></button>
                                    </li>
                                </ul>
                                <div class="media-body well text-warning">
                                ...
                                <div class="media-body well">
                                    ...
                                    <label class="radio inline"><input type="radio"
                                                                       ...
                                                                       rel="{x2;v:data['questionid']}" value="{x2;v:so}"
                                                                       {x2;if:v:so == $sessionvars['examsessionuseranswer'][v:data['questionid']]}checked{x2;endif}/>{x2;v:so}
                                    </label>
                                    {x2;endtree}
                                    {x2;elseif:$questype[v:quest]['questchoice'] == 5}
                                    <input type="text" class="input-xlarge" name="question[{x2;v:data['questionid']}]"
                                ...
                                <div class="media-body well">
                                    ...
                                    <textarea class="jckeditor" etype="simple" id="editor{x2;$dataid}"
                                              name="question[{x2;$dataid}]"
                                              rel="{x2;v:data['questionid']}">{x2;realhtml:$sessionvars['examsessionuseranswer'][$dataid]}</textarea>
                                </div>
                                {x2;endif}
                            </div>
                            {x2;endtree}
    ...
    <div class="modal-body" id="modal-body" style="max-height:560px;">
        ...
        <dl class="clear">
            ...
            <dd>
                ...
                {x2;tree:$sessionvars['examsessionquestion']['questions'][v:quest],question,qnid}
                {x2;eval: v:tid++}
                <a id="sign_{x2;v:question['questionid']}" href="#question_{x2;v:question['questionid']}" rel="0"
                   class="badge questionindex{x2;if:$sessionvars['examsessionsign'][v:question['questionid']]} signBorder{x2;endif}">{x2;v:tid}</a>
                {x2;endtree}
                {x2;tree:$sessionvars['examsessionquestion']['questionrows'][v:quest],questionrow,qrid}
                {x2;eval: v:tid++}
                {x2;tree:v:questionrow['data'],data,did}
                <a id="sign_{x2;v:data['questionid']}" href="#question_{x2;v:data['questionid']}" rel="0"
                   class="badge questionindex{x2;if:$sessionvars['examsessionsign'][v:data['questionid']]} signBorder{x2;endif}">{x2;v:tid}
                    -{x2;v:did}</a>
                {x2;endtree}
                {x2;endtree}
            </dd>
            ...
            <div class="span6">
                <ul class="unstyled">
                    <li><h6>已做 <span class="yesdonumber">0</span> 题 共 <span class="allquestionnumber">50</span> 题
                            总分：<span
                                    class="orange">{x2;$sessionvars['examsessionsetting']['examsetting']['score']}</span>分
                            合格分数线：<span
                                    class="orange">{x2;$sessionvars['examsessionsetting']['examsetting']['passscore']}</span>分
                            考试时间：<span
                                    class="orange">{x2;$sessionvars['examsessionsetting']['examsetting']['examtime']}</span>分钟
                        </h6></li>
                </ul>
            </div>
            <div class="span2">
