        ...
        switch ($subaction) {
            ...
            default:
                ...
                if (!$search)
                    ...
                    $args = [];
                if ($search['basicid']) $args[] = ["AND", "basicid = :basicid", 'basicid', $search['basicid']];
                else {
                    if ($search['keyword']) $args[] = ["AND", "basic LIKE :basic", 'basic', "%{$search['keyword']}%"];
                    if ($search['basicareaid']) $args[] = ["AND", "basicareaid = :basicareaid", 'basicareaid', $search['basicareaid']];
                    if ($search['basicsubjectid']) $args[] = ["AND", "basicsubjectid = :basicsubjectid", 'basicsubjectid', $search['basicsubjectid']];
                    if ($search['basicapi']) $args[] = ["AND", "basicapi = :basicapi", 'basicapi', $search['basicapi']];
    ...
    public function asks()
    {
        ...
        switch ($subaction) {
            ...
            case 'del':
                ...
                $this->G->msg(['url' => '?exam-master-asks&page=' . $page]);
                break;
            ...
            case 'delanswer':
                ...
                $this->G->msg(['url' => '?exam-master-asks-detail&askid=' . $answer['answeraskid'] . '&page=' . $page]);
                break;
            ...
            case 'rely':
                ...
                $this->G->msg(['url' => '?exam-master-asks-detail&askid=' . $id . '&page=' . $page]);
                break;
            ...
            default:
                ...
                if ($sargs['asksubjectid']) $args[] = ["AND", "asks.asksubjectid = :asksubjectid", 'asksubjectid', $sargs['asksubjectid']];
                if ($sargs['asklasttime']) $args[] = ["AND", "asks.asklasttime >= :asklasttime", 'asklasttime', $sargs['asklasttime']];
                if ($sargs['askuserid']) $args[] = ["AND", "asks.asklastteacherid = :asklastteacherid", 'asklastteacherid', $sargs['askuserid']];
                if ($sargs['askstatus']) {
    ...
    public function questions()
    {
        ...
        switch ($subaction) {
            ...
            default:
                ...
                if ($search['etime']) {
                    $args[] = ["AND", "questions.questioncreatetime <= :questioncreatetime", 'questioncreatetime', strtotime($search['etime'])];
                }
    ...
    public function rowsquestions()
    {
        ...
        switch ($subaction) {
            ...
            default:
                ...
                if ($search['etime']) {
                    $args[] = ["AND", "questionrows.qrtime <= :qrtime", 'qrtime', strtotime($search['etime'])];
                }
                if ($search['qrlevel']) {
            ...
            case 'clearhistory':
                if ($search['argsmodel']) {
                    if ($search['stime'] || $search['etime']) {
                        $args = [];
                        if ($search['stime']) $args[] = ["AND", "ehstarttime >= :ehstarttime", 'ehstarttime', strtotime($search['stime'])];
                        if ($search['etime']) $args[] = ["AND", "ehstarttime <= :ehendtime", 'ehendtime', strtotime($search['etime'])];
    ...
    public function exams()
    {
        ...
        switch ($subaction) {
            case 'selectexams':
                ...
                $args = [];
                if ($search) {
                    if ($search['subjectid']) $args[] = ["AND", "examsubject = :examsubject", 'examsubject', $search['subjectid']];
                }
...
//                dump(json_encode($exam['examquestions']));
            ...
            default:
                ...
                $args = [];
                if ($search) {
                    if ($search['examsubject']) $args[] = ["AND", "examsubject = :examsubject", 'examsubject', $search['examsubject']];
                    if ($search['examtype']) $args[] = ["AND", "examtype = :examtype", 'examtype', $search['examtype']];
                }
                if (!count($args)) $args = 1;
                $exams = $this->exam->getExamSettingList($page, 10, $args);
                $subjects = $this->basic->getSubjectList();
