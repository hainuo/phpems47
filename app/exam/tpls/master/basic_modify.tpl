            ...
            <form action="index.php?exam-master-basic-modifybasic" method="post" class="form-horizontal">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="basic" name="args[basic]" type="text" value="{x2;$basic['basic']}"
                        ...
                        <div class="controls">
                            <label class="radio inline">
                                <input name="args[basicclosed]" type="radio" value="0"
                                       {x2;if:!$basic['basicclosed']}checked{x2;endif}/>开启
                            </label>
                            <label class="radio inline">
                                <input name="args[basicclosed]" type="radio" value="1"
                                       {x2;if:$basic['basicclosed']}checked{x2;endif}/>关闭
                            </label>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="basictypeid" name="args[basictypeid]" needle="needle" msg="您必须选择考场分类">
                                ...
                                <option value="{x2;v:type['typeid']}"{x2;if:v:type['typeid'] == $basic['basictypeid']}
                                        selected{x2;endif}>{x2;v:type['type']}</option>
                                {x2;endtree}
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="controls">
                            <div class="thumbuper pull-left">
                                <div class="thumbnail">
                                    ...
                                    <div class="boot"><img
                                                src="{x2;if:$basic['basicthumb']}{x2;$basic['basicthumb']}{x2;else}app/core/styles/images/noimage.gif{x2;endif}"
                                                id="catimg_view"/><input type="hidden" name="args[basicthumb]"
                                                                         value="{x2;$basic['basicthumb']}"
                                                                         id="catimg_value"/></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="basicapi" name="args[basicapi]" type="text" value="{x2;$basic['basicapi']}"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="basicsubjectid" name="args[basicsubjectid]" needle="needle" msg="您必须选择考试科目">
                                ...
                                <option value="{x2;v:subject['subjectid']}"{x2;if:v:subject['subjectid'] == $basic['basicsubjectid']}
                                        selected{x2;endif}>{x2;v:subject['subject']}</option>
                                {x2;endtree}
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="basicareaid" name="args[basicareaid]" needle="needle" msg="您必须选择考试地区">
                                ...
                                <option value="{x2;v:area['areaid']}"{x2;if:v:area['areaid'] == $basic['basicareaid']}
                                        selected{x2;endif}>{x2;v:area['area']}</option>
                                {x2;endtree}
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="controls">
                            <label class="radio inline">
                                <input name="args[basicdemo]" type="radio" value="1"
                                       {x2;if:$basic['basicdemo']}checked{x2;endif}/>是
                            </label>
                            <label class="radio inline">
                                <input name="args[basicdemo]" type="radio" value="0"
                                       {x2;if:!$basic['basicdemo']}checked{x2;endif}/>否
                            </label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="input-xlarge" rows="4" name="args[basicprice]"
                                      id="basicprice">{x2;$basic['basicprice']}</textarea>
